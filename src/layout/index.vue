<template>
  <div class="common-layout-teacher" v-if="isTeacher()">
    <el-container style="height: 100vh;">
      ...
      <el-container>
        <el-aside width="20%" style="height: 100%;">
          <div>
            <div class="layout_slidder" :class="{ fold: LayOutSettingStore.fold }" background-color="#7c0406">
              <logo></logo>
              <el-scrollbar class="scrollbar">
                <el-menu :collapse="LayOutSettingStore.fold" text-color="white" background-color="#7c0406"
...
const isTeacher = () => {
  const currentUserId = localStorage.getItem('userId') || 'T001'
...
.common-layout-teacher .el-aside {
  color: var(--el-text-color-primary);
...
.common-layout-teacher .el-menu {
  border-right: none;
}

.common-layout-teacher .el-main {
  padding: 20px;
  background-color: #E5EAF3;
  box-shadow: 0 4px 12px rgba(65, 22, 221, 0.1);
  border-radius: 10px;
}
