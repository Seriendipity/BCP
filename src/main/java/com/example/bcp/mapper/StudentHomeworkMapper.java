...
public interface StudentHomeworkMapper {
    ...
    @Insert("Insert into StudentHomework(StudentNo,HomeworkNo,SubmitDescription,SubmitPath,SubmitTime,SubmitGrade)" +
            " values(#{StudentNo},#{HomeworkNo},#{SubmitDescription},#{SubmitPath},#{SubmitTime},#{SubmitGrade})")
    ...
    @Update("Update StudentHomework Set SubmitGrade = #{SubmitGrade} Where StudentNo = #{StudentNo} and HomeworkNo = #{HomeworkNo}")
    void updateStudentHomeworkSubmitGrade(int SubmitGrade,String StudentNo,String HomeworkNo);
}
