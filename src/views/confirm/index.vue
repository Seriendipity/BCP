  ...
  <el-card class="box-card">
    ...
    <el-table :data="tableData" :style="{ width: '100%' }">
      ...
      <el-table-column fixed="right" label="Operations" width="200">
        <template #default>
          <el-button link type="primary" size="small" @click="handleClick">审核通过</el-button>
          <el-button link type="primary" size="small">审核不通过</el-button>
        </template>
      </el-table-column>
    </el-table>
  </el-card>
...
import { ref } from 'vue';
import { awardInfo } from '@/api/user/user';
const tableData = ref([
